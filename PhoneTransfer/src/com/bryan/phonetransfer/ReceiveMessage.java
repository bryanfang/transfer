...
public class ReceiveMessage extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(strRes.equals(intent.getAction())){
			Log.i(TAG, "Receive Message - Analyze message information");
	...
	/**
	 * @param: message, the message object from receiver
	 * @return: null
	 * @author I312473
	 */
	@TargetApi(Build.VERSION_CODES.GINGERBREAD)
	private void messageHandler(Context context, SmsMessage message){
		String messageBody = message.getDisplayMessageBody();  //obtain message body
